                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th> Usted <span class="icon-arrow">&UpArrow;</span></th>
                            <th> Ciudad <span class="icon-arrow">&UpArrow;</span></th>
                            <th> Nombre del Inmueble <span class="icon-arrow">&UpArrow;</span></th>
                            <th> solicitud <span class="icon-arrow">&UpArrow;</span></th>
                            <th> Costo <span class="icon-arrow">&UpArrow;</span></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td> 17 Dec, 2022 </td>
                            <td>
                                <p class="status delivered">En Proceso</p>
                            </td>
